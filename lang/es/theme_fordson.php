...
$string['featuretext_desc'] = 'Este texto aparecerá en una fila junto a la imagen de la característica. Utiliza un encabezado 4 para generar un título especial dentro del cuadro de texto. En el Editor de Atto, H4 es un Encabezado (mediano).';
