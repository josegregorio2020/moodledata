...
$string['group_help'] = 'El nombre del grupo en el que se agregarán los usuarios.';
...
$string['userwithoutcapability'] = 'Debes tener el permiso para cancelar la matriculación de los métodos \'{$a}\' en el curso seleccionado';
