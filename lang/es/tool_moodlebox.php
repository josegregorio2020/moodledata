...
$string['dhcpclientinfo'] = 'Dirección IP, nombre y MAC del cliente';
...
$string['moodleboxsysteminfo_help'] = 'El tablero de información de Moodlebox muestra diversos datos importantes acerca de MoodleBox. Esta información incluye:
