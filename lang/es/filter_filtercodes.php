...
$string['unenrolme'] = 'Desmatricularme de este curso';
$string['verbose'] = 'Detallado';
$string['wishlist'] = 'Lisa de deseos';
$string['wishlist_add'] = 'Añadir este curso a la lista de deseos';
$string['wishlist_nocourses'] = 'No hay cursos en la lista';
$string['wishlist_remove'] = 'Eliminar este curso de la lista';
