...
/**
 * Strings for component 'profilefield_database', language 'es_co', version '4.1'.
 *
...
$string['add-new-category'] = 'Agregar nueva categoría';
$string['add-new-data'] = 'Agregar nuevo registro';
...
$string['category_field-info'] = 'Ingrese el nombre del campo que se mostrará en el formulario';
...
$string['category_name-info'] = 'Ingrese el nombre de la categoría que desea utilizar';
...
$string['database:addinstance'] = 'Agregar instancia';
...
$string['edit_values_fields'] = 'Editar los valores de estos campos';
$string['field_type'] = 'Tipo de campo';
$string['field_type-date'] = 'Los datos serán de tipo Fecha';
$string['field_type-info'] = 'Seleccione el tipo de campo que se utilizará';
$string['field_type-int'] = 'Los datos serán de tipo Número';
$string['field_type-text'] = 'Los datos serán de tipo texto';
$string['manage-category-link'] = '<div class="alert alert-warning">Para seleccionar una categoría, primero debes crear y gestionar categorías. Puedes hacerlo accediendo al área de <a href="{$a}/user/profile/field/database/category.php">Todas las categorías</a>.</div>';
$string['missing-value-link'] = 'El campo "Seleccionar categoría" debe tener un valor válido en <a href="{$a}/user/profile/field/database/category.php">Todas las categorías</a>.';
$string['new-category'] = 'Nueva categoría';
$string['new-data'] = 'Nuevo registro';
$string['pluginname'] = 'Campo de usuario DB';
$string['privacy:metadata'] = 'El complemento de base de datos no almacena datos personales ni envía datos a sitios externos.';
