...
class __Mustache_3d4f7aa675fb762733bb54d7d2e0c607 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionEf36134ad07b1fe22e04f113f7cd116b($context, $indent, $value);
        $value = $context->find('displaygroupingselector');
        if (empty($value)) {
...
';
    ...
    private function sectionEf36134ad07b1fe22e04f113f7cd116b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
