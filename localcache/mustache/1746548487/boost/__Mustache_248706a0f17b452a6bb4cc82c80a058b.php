...
class __Mustache_248706a0f17b452a6bb4cc82c80a058b extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template')) {
            $context->pushBlockContext(array(
                'element' => array($this, 'block50334f2e739f21364f758886a6eb8c63'),
            ));
...
';
    ...
    public function block50334f2e739f21364f758886a6eb8c63($context)
    {
        $indent = $buffer = '';
